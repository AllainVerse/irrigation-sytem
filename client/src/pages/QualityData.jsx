   ...
   <table className="w-full text-center text-black mb-12">
    <thead>
      <tr className="border-b-2 border-black">
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">No.</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">Nama Petak</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">Nitrogen</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">Phospor</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">Potassium</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">Temperature</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">Humadity</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">pH</th>
        <th className="py-2 px-2 md:px-3 font-poppins font-medium">Rainfall</th>
      </tr>
    </thead>
    <tbody>
